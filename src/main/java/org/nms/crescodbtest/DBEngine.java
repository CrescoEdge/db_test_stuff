...
public class DBEngine {
    ...
    //NMS I had to add this constructor
    public DBEngine(ControllerEngine ce,ODatabaseDocumentTx db_to_use){
        this.controllerEngine = ce;
        ...
        //Always going to pass in an in-memory db for this
        this.db = db_to_use;
